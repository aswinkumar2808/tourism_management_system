...
<form method="POST" action="confirm_booking.php">
    ...
    <input type="number" name="number_of_people" required><br>

    <p>Total Price: ?<?php echo $package['price']; ?> x <span id="people_count">1</span> people = ?<span id="total_price"><?php echo $package['price']; ?></span></p>
